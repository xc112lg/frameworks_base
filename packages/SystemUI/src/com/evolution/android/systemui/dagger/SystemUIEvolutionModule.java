...
import static com.evolution.android.systemui.Dependency.*;
...
import com.evolution.android.systemui.assist.AssistManagerGoogle;
...
public abstract class SystemUIEvolutionModule {
    ...
    @Provides
    @SysUISingleton
    static EvolutionServices provideEvolutionServices(Context context, UiEventLogger uiEventLogger, Lazy<ColumbusServiceWrapper> lazyB) {
        return new EvolutionServices(context, uiEventLogger, lazyB);
    }
