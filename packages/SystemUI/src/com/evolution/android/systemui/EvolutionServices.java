...
public class EvolutionServices extends VendorServices {
    ...
    @Inject
    public EvolutionServices(Context context, UiEventLogger uiEventLogger, Lazy<ServiceConfigurationGoogle> serviceConfigurationGoogle, Lazy<ColumbusServiceWrapper> columbusService) {
        super(context);
